...
function deleteReply(boardReplyNo, boardLevel, boardNo){
    ...
    .then((result) => {
        if (result.value) {
            window.location = "rdelete.cs?boardLevel=" + boardLevel + "&boardNo=" + boardNo + "&boardReplyNo=" + boardReplyNo;
        }
    })
}
function deleteBoard(boardLevel, boardNo){
    ...
    .then((result) => {
        if (result.value) {
            window.location = "delete.cs?boardLevel=" + boardLevel + "&boardNo=" + boardNo;
        }
    })
}
